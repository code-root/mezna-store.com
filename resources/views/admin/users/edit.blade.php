        ...
        <div class="page-container">
            <div class="page-title-head d-flex align-items-center gap-2">
                <div class="flex-grow-1">
                    <h4 class="fs-16 text-uppercase fw-bold mb-0">تعديل المستخدم</h4>
                    <p class="text-muted mb-0">تعديل بيانات {{ $user->name }}</p>
                </div>
                <div class="text-end">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-control-plaintext">{{ $user->created_at->format('Y/m/d H:i') }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
