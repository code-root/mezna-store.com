...
<head>
    <meta charset="utf-8" />
    <title>تسجيل الدخول - Mezna Store</title>
                        ...
                        <div class="card-body p-4">
                            <div class="text-center w-75 m-auto">
                                <a href="{{ route('admin.dashboard') }}">
                                    <span><img src="https://coderthemes.com/greeva/layouts/assets/images/logo-dark.png"
                                            alt="" height="22"></span>
                                </a>
                                <p class="text-muted mb-4 mt-3">أدخل بريدك الإلكتروني وكلمة المرور للوصول إلى لوحة
                                    التحكم.</p>
                            </div>
