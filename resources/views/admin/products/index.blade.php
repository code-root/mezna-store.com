    ...
    <div class="page-container">
        <div class="page-title-head d-flex align-items-center gap-2">
            <div class="flex-grow-1">
                <h4 class="fs-16 text-uppercase fw-bold mb-0">إدارة المنتجات</h4>
            ...
            <div class="card-body">
                <form method="GET" action="{{ route('admin.products.index') }}" class="row g-3">
                    ...
                    <div class="col-12 d-flex justify-content-end">
                        ...
                        <a href="{{ route('admin.products.index') }}" class="btn btn-outline-secondary"><i class="ti ti-refresh me-1"></i> إعادة تعيين</a>
                    </div>
                </form>
            </div>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            <a href="{{ route('admin.products.show', $product) }}#variants" class="btn btn-sm btn-soft-info" title="المتغيرات"><i class="ti ti-list"></i></a>
                                            <a href="{{ route('admin.products.show', $product) }}" class="btn btn-sm btn-soft-primary" title="عرض"><i class="ti ti-eye"></i></a>
                                            <a href="{{ route('admin.products.edit', $product) }}" class="btn btn-sm btn-soft-secondary" title="تعديل"><i class="ti ti-edit"></i></a>
                                ...
                                <tr>
                                    <td colspan="6" class="text-center py-5">
                                        <div class="text-muted">
                                            <i class="ti ti-box text-muted display-1"></i>
                                            <h5 class="mt-3">لا توجد منتجات</h5>
                                            <p>لم يتم العثور على أي منتجات في النظام</p>
                                            <a href="{{ route('admin.products.create') }}" class="btn btn-primary"><i class="ti ti-plus me-1"></i> إضافة منتج جديد</a>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
